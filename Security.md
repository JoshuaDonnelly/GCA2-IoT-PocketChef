...
- When we added the accounts feature we also added in new security measures.

- We added in encryption to the user data aswell as their cooking sessions.
...
- Websever -> Database
Within our AWS , we have our database which saves all the encrypted data within the MySql section of the instance.
