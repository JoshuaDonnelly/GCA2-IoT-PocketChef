...
# Config
EC2_SERVER = os.getenv("EC2_SERVER", "http://AWS:5000")
PI_UUID = os.getenv("PI_UUID", "raspi-01")
CHANNEL = os.getenv("PUBNUB_CHANNEL", "raspi")
TOKEN_REFRESH_INTERVAL = int(os.getenv("TOKEN_REFRESH_INTERVAL", str(50 * 60)))
...
pnconfig.ssl = os.getenv("PUBNUB_SSL", "True").lower() == "true"
